  ...
  return (
    <Fragment>
      {toolbar ? (
        ...
        <Link to='/orders'><i className="fas fa-file-alt grow" id="icon"><div className="icon-text">Mine ordre</div></i></Link>
        <Link to="!#"><i className="fas fa-industry grow" id="icon"><div className="icon-text">Min bedrift</div></i></Link>
        </div>
      </nav>
      ) : (
        ...
        <Link to='/orders'><i className="fas fa-file-alt grow" id="icon"></i></Link>
        <Link to="!#"><i className="fas fa-industry grow" id="icon"></i></Link>
        </div>
      </nav>
      )}
